defmodule Aquarelle.ImageControllerTest do
  use Aquarelle.ConnCase

  alias Aquarelle.Image
  @valid_attrs %{created: "2010-04-17 14:00:00", description: "some content", extension: "some content", key: "some content", medium: "some content", slug: "some content", title: "some content"}
  @invalid_attrs %{}
  ...
  test "shows chosen resource", %{conn: conn} do
    ...
    assert html_response(conn, 200) =~ "itemprop"
  end
